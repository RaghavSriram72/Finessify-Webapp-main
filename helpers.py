...
# def createGoogleEvent(activity, start_time, end_time):

#     date = []
#     Current_Date = datetime.today().strftime('%d %m %y')
#     Current_Dateformatted = nltk.words_tokenize(str(Current_Date))

#     for each_date in Current_Dateformatted:
#         date.append(each_date) I
...
#     start_time = datetime(date[0], date[1], date[2], start_time, end_time, 0)
...
# def getTime(tasks, user_sleep):

#     sleep = nltk.word_tokenize(user_sleep)

#     activities = .word_tokenize(tasks)
